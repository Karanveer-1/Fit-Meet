...
public class CreateEventActivity extends AppCompatActivity {
    private static final String TAG = "Create Event Date time";
    ...
    private void addToDB(final String eventNameString, final String descriptionString, final String locationString) {
        ...
        imageRef = storageRef.child(imageID);
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(CreateEventActivity.this,"Error in uploading!",Toast.LENGTH_SHORT).show();
    ...
    private void initialiseDateTime() {
        if(dateTimeFragment == null) {
            dateTimeFragment = SwitchDateTimeDialogFragment.newInstance("date", "ok", "cancel", "Clear");
        }
